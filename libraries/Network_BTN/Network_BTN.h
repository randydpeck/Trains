...
#ifndef NETWORK_BTN_h
#define NETWORK_BTN_h

#include "Network_RS485.h"
#include "Train_Consts_Global.h"

class Network_BTN : public Network_RS485 {

  public:

    // Constructor:
    Network_BTN(HardwareSerial * hdwrSerial, long unsigned int baud, Display_2004 * LCD2004);

// Message_MAS is a child class of Message_RS485: it handles the construction/deconstruction of message fields
// Rev: 04/20/18

#include <Message_MAS.h>

// A_MAS both sends and receives RS485 messages, and also needs to read a digital signal.

// Here is how you call the Parent constructor from the child constructor, passing it the parameter(s) it needs.
Message_MAS::Message_MAS(Display_2004 * LCD2004) : Message_RS485(myModuleID, myLCD)
{
...
bool Message_MAS::Receive(byte tMsg[]) {
